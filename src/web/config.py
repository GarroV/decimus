...
#: Соседний с MCP (8265): обе поверхности продукта стоят рядом и обе слушают
#: только петлю. Номер — умолчание продукта, а не рабочей копии: у копий свои
#: диапазоны, и задаются они переменной, а не правкой кода.
DEFAULT_PORT = 8266

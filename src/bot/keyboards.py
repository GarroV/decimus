...
def sealed_keyboard(lang: str) -> InlineKeyboardMarkup:
    ...
    оставшиеся — ровно то, что решение D080 оставило вместо неё: удалить
    сданную проверку или завести новую. Показывается эта клавиатура и на
    `/start`, и рядом с каждым отказом:

...
class Finding:
    ...
    #: Аудитор отметил запись как повтор нарушения предыдущей проверки: вычет
    #: за неё удвоен (D191). Это РЕШЕНИЕ человека о цене, а не совпадение кода
    #: с историей: тот же код мог относиться к другому объекту, а исправленное
    #: и снова сломавшееся отличается от неисправленного.
    repeat: bool = False

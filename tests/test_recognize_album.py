"""Пачка кадров с комментарием в разборе (D208): кадры уходят модели, увиденное — отдельно.

До D208 кадры с комментарием в модель не шли вовсе (D081). Боевой случай
...
def test_один_кадр_с_комментарием_тоже_уходит_модели(
    ...
    """D209: одиночный кадр с подписью модель видит, а время отправки уходит в запрос."""

...
Решение D064 сняло кнопку подтверждения с текстового пути — с открытой дверью
вернуть её позже. Слова аудитора, однозначно легшие на карту нарушений,
больше не ждут нажатия — запись появляется в тот же момент. Для кадра
подтверждение остаётся: там пункт

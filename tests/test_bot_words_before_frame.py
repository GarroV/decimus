...
#: колонка выбрана словом «грязная» → CLN05. Зону слова не называют — карта
#: кадров держит её сама («Печь» → `hot_kitchen`, T262/T263); памяти о прошлой
#: записи среди источников зоны больше нет (T264).
OVEN = "печь грязная"
...
#: Строка «Мебель участка» карты кадров (в отличие от «Печи») зоны не держит
#: вовсе, поэтому она названа словами явно.
FURNITURE = "мебель участка грязная, в тепловом участке"

...
которому в блок быстрого пути вносили вопрос пункта: на примере «кассовая
зона, просрочка чизкейк» и `CLN02`, и `PRD10` выглядят одинаково правдоподобно,
пока их не прочитать словами.
